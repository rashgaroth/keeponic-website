...
import { getArticleDetail, updateArticleDetail } from '../../../redux/actions';
//  Region Import Utility/Helper Function

//  Region Import Components
import CustomImage from '../../admin/faq-management/components/CustomImage';
...
class ArticleDetail extends Component {
	...
	componentWillReceiveProps(nextProps) {
		if (nextProps.article !== this.props.article) {
			...
			this.setState({
				...
				imageFirst: nextProps.article.image,
				createdDate: nextProps.article.created_date,
	...
	submitAllForm = async () => {
		...
		data && this.props.updateArticleDetail(data, this.props.match.params.id);
	};
...
const mapStateToProps = (state) => {
	const { loading, article } = state.ArticleReducers;
